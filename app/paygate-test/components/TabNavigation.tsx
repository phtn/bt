...
const tabs: { id: EndpointType; label: string }[] = [
  ...
  { id: 'hosted-payment', label: 'Hosted Payment' },
  { id: 'status', label: 'Check Status' },
  { id: 'create', label: 'Create Payment' },
  { id: 'affiliate', label: 'Affiliate Wallet' },
  { id: 'currency-converter', label: 'USD Converter' },
  { id: 'callback-simulator', label: 'Callback Simulator' }
]
