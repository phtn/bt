...
export function ConfigForm({ onSubmit, loading }: ConfigFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className='bg-surface-light dark:bg-surface-dark p-6 rounded-lg shadow-lg'>
      <h2 className='text-2xl font-semibold mb-4'>Config</h2>
      <p className='text-sm text-gray-600 dark:text-gray-400 mb-4'>
        Retrieve configuration information from the Meld API
      </p>
      ...
      <div className='space-y-4'>
        ...
        <button
          type='submit'
          disabled={loading}
          className='w-full bg-primary text-background py-2 px-4 rounded-lg font-medium hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity'>
