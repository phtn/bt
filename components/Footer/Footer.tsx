...
export function Footer() {
  return (
    <footer className='border-t border-slate-200 dark:border-white/10 bg-surface-light dark:bg-background pt-16 pb-8'>
      <div className='layout-content-container max-w-300 mx-auto px-4 md:px-10'>
        <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12'>
          <div className='col-span-2 lg:col-span-2 flex flex-col gap-4'>
            <div className='flex items-center gap-3 text-slate-900 dark:text-white'>
              ...
              <h2 className='text-xl font-extrabold tracking-tight'>BigTicket</h2>
            </div>
        ...
        <div className='border-t border-slate-200 dark:border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4'>
          <p className='text-slate-400 text-sm'>© 2026 BigTicket Inc. All rights reserved.</p>
