...
function DrawerHandle({ ...props }: ComponentProps<typeof DrawerPrimitive.Handle>) {
  ...
  return (
    <DrawerPortal data-slot='drawer-portal'>
      ...
      <DrawerPrimitive.Content
        ...
        {...props}>
        <div className='bg-foreground/20 mx-auto mt-3 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block' />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
