...
//               <Button variant='outline' onClick={generateHarmoniousColors} className='text-sm'>
//                 Generate Harmonious Colors
//               </Button>
//               <Button variant='outline' onClick={resetColors} className='text-sm'>
//                 <Icon name='re-up.ph' className='w-4 h-4 mr-2' />
//                 Reset Colors
//               </Button>
//             </div>
...
//                       <Button variant='ghost' size='sq' className='ml-2' onClick={() => toggleLock(key)}>
//                         <Icon name={lockedColor === key ? 'x' : 'plus'} className='h-4 w-4' />
//                       </Button>
//                     </div>
...
//                 .map(([key, value]) => (
//                   <div key={key} className='flex flex-col md:flex-row gap-4 md:items-center justify-between'>
//                     <span>{key}</span>
//                     <TooltipProvider>
//                       <Tooltip>
...
//                             }}>
//                             {value}
//                             <Icon name={copied ? 'check-fill' : 'search'} className='w-4 h-4 ml-2' />
//                           </Button>
//                         </TooltipTrigger>
//                         <TooltipContent>
//                           <p>Click to copy</p>
...
// export const NewThemePicker = ({ value }: NewThemePickerProps) => {
//   const [colorScheme, setColorScheme] = useState<Record<string, string> | null>(null)
//   const handleSetColorScheme = (c: ColorScheme) => {
//     setColorScheme(() => ({
//       ...colorScheme
//     }))
//   }
...
//     const [h, s, l] = color.match(/\d+(\.\d+)?/g)?.map(Number) ?? [0, 0, 0]
//     const n = `${h.toFixed(1)} ${s.toFixed(1)}% ${l.toFixed(1)}%`
//     console.log(n)
//     handleSetColorScheme({ x: n })
//   }
//   return (
//     <div className='relative'>
//       <div className='flex items-center'>
//         <ColorPicker color={`hsl(${value})`} onChange={handleColorChange(value)} />
//       </div>
//     </div>
//   )
// }
