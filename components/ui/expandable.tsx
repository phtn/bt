...
//             'bg-white dark:bg-[#565656]/80',
//             {
//               'bg-gradient-to-br from-white via-orange-50 to-primary/40 dark:from-background/90 dark:via-black/70 dark:via-75% dark:to-primary/40':
//                 isExpanded,
//             },
//           )}>
