...
//       accent:
//         'w-full border-[1px] dark:border-[2px] border-black/10 dark:border-neutral-950 bg-gradient-to-b from-primary-hover to-primary dark:from-primary-hover dark:to-primary p-[1px] transition duration-300 ease-in-out ',
//       destructive:
...
//         accent:
//           'gap-2 bg-gradient-to-b from-primary to-primary text-sm text-white/90 transition duration-300 ease-in-out hover:bg-gradient-to-b hover:from-primary-hover hover:to-primary dark:hover:from-primary-hover dark:hover:to-primary active:bg-gradient-to-b active:from-primary-hover active:to-primary-hover dark:active:from-primary-hover dark:active:to-primary-hover',
//         destructive:
