export const icons = {
  ...
  'arrow-down': {
    symbol:
      '<path fill="currentColor" d="m12 18l-.354.354l.354.353l.354-.353zm.5-12a.5.5 0 0 0-1 0zm-4.854 8.354l4 4l.708-.708l-4-4zm4.708 4l4-4l-.708-.708l-4 4zM12.5 18V6h-1v12z"/>',
    viewBox: '0 0 24 24',
    set: 'lets-icons'
  },
  ...
  search: {
    symbol:
      '<g fill="none" stroke="currentColor"><circle cx="11" cy="11" r="6"/><path stroke-linecap="round" d="m20 20l-3-3"/></g>',
    viewBox: '0 0 24 24',
    set: 'lets-icons'
  },
  ...
  minus: {
    symbol: `<path fill="currentColor" d="M19 13H5v-2h14v2z"/>`,
    viewBox: '0 0 24 24',
    set: 'material'
  },
  plus: {
    symbol: `<path fill="currentColor" d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/>`,
    viewBox: '0 0 24 24',
    set: 'material'
  },
  eye: {
  ...
  user: {
    symbol: `<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2"><path d="M19.727 20.447c-.455-1.276-1.46-2.403-2.857-3.207S13.761 16 12 16s-3.473.436-4.87 1.24s-2.402 1.931-2.857 3.207"></path><circle cx="12" cy="8" r="4"></circle>`,
    viewBox: `0 0 24 24`,
    set: `lets-icons`
  },
  'toggle-theme': {
  ...
  upload: {
    symbol: `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 16.349V3.87M6.118 9.132l4.821-4.821c.293-.293.677-.44 1.061-.44m5.882 5.261l-4.821-4.821A1.5 1.5 0 0 0 12 3.87m8.75 12.645v.935a3.3 3.3 0 0 1-3.3 3.3H6.55a3.3 3.3 0 0 1-3.3-3.3v-.935"></path>`,
    viewBox: `0 0 24 24`,
    set: 'proicons'
  },
  ...
  'check-ring-light': {
    symbol: '<g fill="none" stroke="currentColor"><circle cx="12" cy="12" r="9"/><path d="m8 12l3 3l5-6"/></g>',
    viewBox: '0 0 24 24',
    set: 'lets-icons'
  },
  ...
  file: {
    symbol:
      '<path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z" fill="none" stroke="currentColor" stroke-width="2"/><polyline points="13 2 13 9 20 9" fill="none" stroke="currentColor" stroke-width="2"/>',
    viewBox: '0 0 24 24',
    set: 'lucide'
  },
  'credit-card': {
    symbol:
      '<g fill="none" stroke="currentColor" stroke-width="1.5"><rect width="18.5" height="14" x="2.75" y="5" stroke-linecap="round" stroke-linejoin="round" rx="3"/><path d="M2.75 9.5h18.5"/><path stroke-linecap="round" d="M14.75 14.25h3"/></g>',
    viewBox: '0 0 24 24',
    set: 'proicons'
  },
  solana: {
  ...
  'rocket-launch': {
    symbol:
      '<path fill="currentColor" d="m2.45 10.575l4.2-4.2q.35-.35.825-.5t.975-.05l1.3.275Q8.4 7.7 7.625 9t-1.5 3.15zm5.125 2.275q.575-1.8 1.563-3.4t2.387-3q2.2-2.2 5.025-3.287t5.275-.663q.425 2.45-.65 5.275T17.9 12.8q-1.375 1.375-3 2.388t-3.425 1.587zm6.9-3q.575.575 1.413.575T17.3 9.85t.575-1.412t-.575-1.413t-1.412-.575t-1.413.575t-.575 1.413t.575 1.412m-.7 12.025l-1.6-3.675q1.85-.725 3.163-1.5t2.912-2.125l.25 1.3q.1.5-.05.988t-.5.837zM4.05 16.05q.875-.875 2.125-.888t2.125.863t.875 2.125t-.875 2.125q-.625.625-2.087 1.075t-4.038.8q.35-2.575.8-4.025T4.05 16.05"/>',
    viewBox: '0 0 24 24',
    set: 'material-symbols'
  },
  'chevrons-right': {
    symbol:
      '<path fill="currentColor" fill-rule="evenodd" d="M3.47 10.97a.75.75 0 1 0 1.06 1.06l3.5-3.5a.75.75 0 0 0 0-1.06l-3.5-3.5a.75.75 0 0 0-1.06 1.06L6.44 8zm5 0a.75.75 0 1 0 1.06 1.06l3.5-3.5a.75.75 0 0 0 0-1.06l-3.5-3.5a.75.75 0 0 0-1.06 1.06L11.44 8z" clip-rule="evenodd"/>',
    viewBox: '0 0 16 16',
    set: 'gravity-ui'
  },
  'chevrons-right-light': {
    symbol:
      '<g fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"><path d="M6.94 7.646a.5.5 0 0 1 .707 0L12 12l-4.353 4.354a.5.5 0 0 1-.708-.708L10.586 12L6.939 8.354a.5.5 0 0 1 0-.708"/><path d="M12.147 7.646a.5.5 0 0 1 .707 0L17.207 12l-4.353 4.354a.5.5 0 0 1-.707-.708L15.793 12l-3.646-3.646a.5.5 0 0 1 0-.708"/></g>',
    viewBox: '0 0 24 24',
    set: 'stash'
  },
  'spinner-dots': {
  ...
  'chevron-double': {
    symbol:
      '<g fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"><path d="M5.348 7.116a1.25 1.25 0 0 1 1.768 0L12 12l-4.884 4.884a1.25 1.25 0 0 1-1.768-1.768L8.464 12L5.348 8.884a1.25 1.25 0 0 1 0-1.768"/><path d="M12.366 7.116a1.25 1.25 0 0 1 1.768 0L19.018 12l-4.884 4.884a1.25 1.25 0 0 1-1.768-1.768L15.482 12l-3.116-3.116a1.25 1.25 0 0 1 0-1.768"/></g>',
    viewBox: '0 0 24 24',
    set: 'stash'
  }
}
